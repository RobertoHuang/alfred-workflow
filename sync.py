...
SRC = r'.'
DEST = r'/Users/huangtaihong/Library/Application Support/Alfred/Alfred.alfredpreferences/workflows/user.workflow.3977AB4E-5974-487C-A288-FACBBF7362C4/'
# 忽略的文件
IGNORE = ['info.plist', 'icon.png']
